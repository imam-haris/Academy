        ...
        <section className="features" id="programs">
          <div className="container">
            ...
            <div className="features-grid">
              ...
              {/* Course 3 - Railway */}
              <div className="feature-card animate-on-scroll course-card-new">
                <div className="course-card-image">
                ...
                <div className="course-card-content">
                  ...
                  <a href="/contact" className="btn-primary btn-sm">Join Now</a>
                </div>
              </div>
              ...
              {/* Course 5 - Banking */}
              <div className="feature-card animate-on-scroll course-card-new">
                <div className="feature-card-icon-styled">
              ...
              <div className="feature-card animate-on-scroll course-card-new">
                <div className="feature-card-icon-styled">
                  <svg viewBox="0 0 48 48" fill="none"><circle cx="24" cy="24" r="20" stroke="url(#p5)" strokeWidth="2" /><path d="M24 14V24L30 30" stroke="url(#p5)" strokeWidth="2" strokeLinecap="round" /><defs><linearGradient id="p5" x1="6" y1="14" x2="42" y2="34"><stop stopColor="#8b5cf6" /><stop offset="1" stopColor="#ec4899" /></linearGradient></defs></svg>
                </div>
                <div className="course-card-content">
                  <h3>Reasoning Special Batch</h3>
                  <p>Duration: <strong>6 Months</strong><br />Fees: <strong>₹4,000</strong></p>
                  <a href="/contact" className="btn-primary btn-sm">Join Now</a>
                </div>
              </div>
              ...
              {/* Course 12 - Mock Test */}
              <div className="feature-card animate-on-scroll course-card-new" style={{ gridColumn: '1 / -1', maxWidth: '400px', margin: '0 auto', width: '100%' }}>
                <div className="feature-card-icon-styled">
